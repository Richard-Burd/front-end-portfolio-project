...
let importPostItNoteFromClassInstanceToDOM: () => void;
...
importPostItNoteFromClassInstanceToDOM = () => {
  ...
  let noteBuilder1 = document.createElement('div') as HTMLElement;
  ...
  let noteBuilder2 = document.createElement('img') as HTMLElement;
  ...
  let noteBuilder3 = document.createElement('textarea') as HTMLElement;
